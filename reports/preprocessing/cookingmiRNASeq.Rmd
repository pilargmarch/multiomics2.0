...
We'll select as significant those genes with a p.adj < 0.05 and a lFC > 1 or lFC < -1. We get a total of 133 upregulated DEGs (a 27% of the filtered genes) in cancer samples, compared to normal ones; and 81 downregulated DEGs (a 16.5% of the filtered genes), from a total of 491 filtered miRNAs (originally 1,881 miRNAs in our raw data).
...
We have 119 DEGs, a 24.2% of the filtered miRNAs (491) and a 6.3% of the original miRNAs (1,881).