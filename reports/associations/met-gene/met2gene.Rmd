...
Methylation annotation was automatically retrieved from Methylation Array Gene Annotation File (Gencode v36) (<https://gdc.cancer.gov/about-data/gdc-data-processing/gdc-reference-files>) when downloading through `TCGAbiolinks`. All the used methylation arrays are Illumina Human Methylation 450.
